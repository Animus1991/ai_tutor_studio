...
export const SPINE_ADOPTION: readonly AdoptionCard[] = [
  ...
  },
  {
    ...
    modules: [
      'src/pages/Tasks.tsx',
      'src/lib/fsrs.ts',
      'src/lib/googleTasksSync.ts',
      'src/lib/calibration.ts',
      'src/lib/spineEvents.ts',
    ],
    notes: 'FSRS + learning events · expireAt TTL · TASK_COMPLETED audit',
  },
  {
    id: 4,
    surface: 'Agent',
    ...
    modules: [
      'server/agentModes.ts',
      'src/lib/ragGrounding.ts',
      'src/lib/agentChatStorage.ts',
      'server/circuitBreaker.ts',
    ],
    notes: 'Versioned transcripts · X-Agent-Latency-Ms · learning events per turn',
  },
  {
    id: 5,
    ...
    notes: 'LIBRARY_PUT/RAG_INDEX audit · pedagogy on persist · expireAt + purge',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    modules: [
      'yjsServer.ts',
      'server/yjsSnapshotStore.ts',
      'server/socialPolicy.ts',
      'src/pages/CollabRoom.tsx',
      'src/lib/spineEvents.ts',
    ],
    notes: 'Auth’d Yjs · COLLAB_MESSAGE observe/pedagogy · Meet dual-consent',
  },
  {
    id: 9,
    ...
    modules: ['src/lib/safeSocial.ts', 'src/lib/socialPolicy.ts', 'src/pages/StudyCircles.tsx'],
    notes: 'Invite-only · CIRCLE_CREATE/OPEN events · guidelines gate',
  },
  {
    id: 10,
    surface: 'Study Match',
  ...
  },
  {
    ...
    modules: [
      ...
      'src/lib/calendarSnapshot.ts',
      'server/googleWorkspaceAudit.ts',
      'src/lib/contactsConsent.ts',
    ],
    notes: 'Scoped OAuth · Calendar LWW snapshot · Meet/Forms audit',
  },
  {
    id: 13,
    surface: 'Admin / Ops',
  ...
  },
  {
    ...
    notes: 'Uid-bound packs + TTL · flush auth gate · pedagogy replay · OFFLINE_FLUSH audit',
  },
  {
    id: 15,
